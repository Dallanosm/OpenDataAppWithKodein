...
interface OpenDataService {
    ...
    companion object {
        val END_POINT = "http://opendata.caceres.es/"
    }

    @GET("sparql?default-graph-uri=&query=SELECT+%3Fgeo_long+as+%3Flng+%3Fgeo_lat+as+%3Flat+%3Fom_tipoMonumento+%3Frdfs_label" +
